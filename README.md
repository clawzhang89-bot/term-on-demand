...
**推荐实现：** 详见 [⌨️ 输入方案文档](docs/03-input.md)。核心变化：
- **物理推荐：8BitDo Micro**（¥180，6键+方向键，蓝牙 HID，可自定义映射）
- **软件推荐：Android 悬浮窗虚拟 Macropad**（零硬件，可并入 Voice/Key Daemon）
- **上手路线：Phase 0 零成本运行 → Phase 1 添置实体按键**
